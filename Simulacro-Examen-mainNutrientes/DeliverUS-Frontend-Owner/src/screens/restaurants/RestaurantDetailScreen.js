      ...
      >
        ...
        {!item.availability &&
          <TextRegular textStyle={styles.availability }>Not available</TextRegular>
                  ...
                  <TextSemiBold textStyle={styles.nutrition}>{item.calorias.toFixed(2)} por 100g</TextSemiBold>
                  <TextSemiBold textStyle={styles.nutrition}>{item.proteinas.toFixed(2)} por 100g</TextSemiBold>
                  <TextSemiBold textStyle={styles.nutrition}>{item.grasas.toFixed(2)} por 100g</TextSemiBold>
                  <TextSemiBold textStyle={styles.nutrition}>{item.carbohidratos.toFixed(2)} por 100g</TextSemiBold>
