...
export default function CreateProductScreen ({ navigation, route }) {
  ...
  const initialProductValues = { name: null, description: null, price: null, order: null, restaurantId: route.params.id, productCategoryId: null, availability: true, proteinas: 0.0, grasas: 0.0, carbohidratos: 0.0 }
  ...
  const createProduct = async (values) => {
    ...
    try {
      ...
      showMessage({
        message: `Product no se puedo crear por ${error}`,
        type: 'error',
